...
import { getOrganizationSchema, getFaqSchema } from "@/lib/seo/schema";
...
export default function TallyToZohoBooksPage() {
  ...
  const faqSchema = getFaqSchema([
    ...
    {
      question: "What data gets migrated from Tally to Zoho Books?",
      answer: "We migrate chart of accounts, customers, vendors, items with HSN/SAC codes, opening balances, sales invoices, purchase bills, receipts, payments, journal vouchers, and tax configurations.",
    },
    {
      question: "Is the migration GST-compliant?",
      answer: "Yes. We configure GST settings, tax rates, and HSN/SAC codes as per Indian GST regulations. We also ensure trial balance reconciliation matches your Tally data.",
    },
    {
      question: "What is the cost of Tally to Zoho Books migration?",
      answer: "We offer fixed-price migration packages based on data volume and complexity. Contact us for a free assessment and custom quote.",
    },
    {
      question: "Do you provide post-migration support?",
      answer: "Yes. We provide 30-day post-migration support to address any issues and ensure your team is comfortable using Zoho Books.",
    },
  ]);
  ...
  return (
    <main className="deep-navy scroll-smooth">
      <JsonLd data={[organizationSchema, breadcrumbSchema, faqSchema, serviceSchema]} />
      <TallyHeroSection />
      <LogoSlider />
      <ServiceSeoSection
