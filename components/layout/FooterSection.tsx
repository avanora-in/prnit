          ...
          <div className="grid py-6 sm:py-8 md:py-10 text-xs sm:text-sm md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-white/20">
            <div className="space-y-3 sm:space-y-4 py-6 md:py-0 md:pr-6">
              ...
              <div className="grid grid-cols-2 gap-x-4 sm:gap-x-6 md:gap-x-8 gap-y-2 sm:gap-y-2.5 md:gap-y-3">
                ...
                <Link href="/solar-os" className="relative block transition-colors duration-300 ease-in-out hover:text-[#8B1E2D]
                    after:content-[''] after:absolute after:left-0 after:bottom-0 
                    after:w-full after:h-[2px] after:bg-[#8B1E2D]
                    after:scale-x-0 after:origin-left after:transition-transform after:duration-300 after:ease-in-out
                ...
                <Link href="/zoho-migration" className="relative block transition-colors duration-300 ease-in-out hover:text-[#8B1E2D]
                    after:content-[''] after:absolute after:left-0 after:bottom-0 
                    after:w-full after:h-[2px] after:bg-[#8B1E2D]
                    after:scale-x-0 after:origin-left after:transition-transform after:duration-300 after:ease-in-out
                    hover:after:scale-x-100 w-fit">Zoho Migration</Link>

                <Link href="/services/tally-to-zoho-books" className="relative block transition-colors duration-300 ease-in-out hover:text-[#8B1E2D]
                    after:content-[''] after:absolute after:left-0 after:bottom-0 
                    after:w-full after:h-[2px] after:bg-[#8B1E2D]
                    after:scale-x-0 after:origin-left after:transition-transform after:duration-300 after:ease-in-out
                    hover:after:scale-x-100 w-fit">Tally to Zoho Books</Link>
