...
const faqData = [
  {
    ...
    answer:
      "PRNIT offers AI-powered app development, cloud & DevOps services, custom web development, mobile app development (iOS & Android), e-commerce solutions, CRM development, data engineering, QA & testing, and Zoho consulting from Jaipur, India.",
  },
  {
    question: "How long has PRNIT been in business?",
    answer:
      "PRNIT was founded in January 2011 by Praveen Singh Shekhawat, giving the company over 14 years of experience delivering software solutions for startups and enterprises globally.",
  },
  {
    question: "Which industries does PRNIT serve?",
    answer:
      "PRNIT specialises in SaaS, healthtech, logistics, fintech, retail, and education — building scalable, architecture-first software for companies across India, the US, UK, UAE, and Australia.",
  },
  {
    question: "Is PRNIT ISO certified?",
    answer:
      "Yes. PRNIT is ISO/IEC 27001:2022 certified, reflecting its commitment to information security management and enterprise-grade data protection standards.",
  },
];
        ...
        <div className="grid grid-cols-1 gap-4 md:gap-6">
          ...
          <div className="space-y-4">
            {faqData.slice(2).map((faq, index) => (
              <FAQItem key={index + 2} faq={faq} index={index + 2} />
            ))}
          </div>
        </div>
      </div>
