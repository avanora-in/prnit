          ...
          >
            {[...testimonials, ...testimonials].map((t, index) => (
              <SwiperSlide key={`${t.name}-top-${index}`} className="!w-[260px] sm:!w-[280px] md:!w-[312px]">
                <article className="flex h-full min-w-[260px] sm:min-w-[280px] md:min-w-[312px] flex-col gap-4 rounded-xl sm:rounded-2xl border border-[rgba(15,15,15,0.05)] bg-[rgba(15,15,15,0.05)] p-3 sm:p-4 backdrop-blur-[10px]">
