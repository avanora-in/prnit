...
export default function TestimonialsSection() {
  return (
    ...
    >
      ...
      />
      <div className="relative z-10 mx-auto max-w-[1320px] px-4 sm:px-5 md:px-6 space-y-8 sm:space-y-10 md:space-y-12 py-12 sm:py-16 md:py-20 lg:py-24">
          ...
          >
            {[...testimonials, ...testimonials].map((t, index) => (
              <SwiperSlide key={`${t.name}-top-${index}`} className="!w-[260px] sm:!w-[280px] md:!w-[312px]">
                <article className="flex h-full min-w-[260px] sm:min-w-[280px] md:min-w-[312px] flex-col gap-3 sm:gap-4 rounded-xl sm:rounded-2xl border border-[rgba(15,15,15,0.05)] bg-[rgba(15,15,15,0.05)] p-3 sm:p-4 backdrop-blur-[10px]">
                  ...
                  <div className="mt-auto flex items-center gap-2 sm:gap-3">
                    ...
                    <div className="space-y-0.5">
                      <p className="text-xs sm:text-sm font-semibold primary-black">
                        {t.name}
                      </p>
                      <p className="text-[9px] sm:text-[10px] primary-black">
                        {t.role}
                      </p>
                    </div>
                  </div>
