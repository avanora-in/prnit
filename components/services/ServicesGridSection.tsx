...
const services = [
  ...
  },
  {
    ...
    description:
      "Global Zoho One implementation — CRM, Books, Creator, Analytics and full suite for India, UAE, US, UK, Australia and beyond.",
    href: "/zoho-consulting-partner",
    features: ["Zoho CRM & Books", "Zoho One Suite", "Multi-Country Tax Setup", "Fixed-Scope Projects"],
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
