      ...
      <div className="mx-auto max-w-[1320px] flex items-center py-20 md:py-28 lg:py-32 min-h-[50vh] md:min-h-[70vh] px-4 sm:px-6 md:px-8">
        <div ref={heroRef} className="space-y-4">
          ...
          <p className="text-sm sm:text-base md:text-lg primary-black mb-8 max-w-4xl mx-auto">
            We are veteran e-commerce developers and we deliver apps across a vast industry spectrum and geographical boundaries like US, UK, Canada &amp; many more countries. We build robust, scalable e-commerce solutions that transform your business vision into reality.
          </p>
